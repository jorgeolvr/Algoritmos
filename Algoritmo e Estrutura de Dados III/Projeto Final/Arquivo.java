...
public class Arquivo<T extends Entidade> {
    ...
    public Arquivo(Class<T> c, String n, String in1) throws Exception {
        nomeArquivo = n;
        classe = c;
    ...
    public Entidade buscarCodigo(int c) throws Exception {
    ...
    public void reorganizar() throws Exception {
        ...
        T       r2 = classe.newInstance();
        T       r3 = classe.newInstance();
        T       rAnt1, rAnt2, rAnt3;
        int     s;
        byte[]  b;
