   ...
   public static void relacaoAmizade(String [] nomes, int [] cont, String amigos [][], int relacao [][]) {
      ...
      if(nome.equals(nomes[0])) {
         ...
         System.out.print("Os amigos de "+nomes[6]+" são: ");
            ...
            System.out.println("----------------------------------------------");
         System.out.println("\nPessoa com maior número de amigos\n");
         int soma = 0;
         int linha = 0;
         int temp = 0;
         for(int i = 0; i < relacao.length; i++) {
            ...
            System.out.println("Pessoa com maior número de amigos é "+nomes[linha]+" com "+temp+" amigos\n");
            }
